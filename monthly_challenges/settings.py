...
SECRET_KEY = 'django-insecure-51r^95y$61^*sly-!al&^89f8h$s0#pqlzz$2efvh($k#11xnx'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles', # this req to handle static files like .css
]
...
# ADD CUSTOM STATIC FOLDERS HERE TO TELL DJANGO TO LOOK INTO THIS FOLDER
STATICFILES_DIRS = [
    BASE_DIR / 'static'
]
